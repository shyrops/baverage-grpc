...
type GetBeveragesParams struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetBeveragesParams) Reset() {
	*x = GetBeveragesParams{}
	if protoimpl.UnsafeEnabled {
		mi := &file_beveragesmgmt_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetBeveragesParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBeveragesParams) ProtoMessage() {}

func (x *GetBeveragesParams) ProtoReflect() protoreflect.Message {
	mi := &file_beveragesmgmt_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBeveragesParams.ProtoReflect.Descriptor instead.
func (*GetBeveragesParams) Descriptor() ([]byte, []int) {
	return file_beveragesmgmt_proto_rawDescGZIP(), []int{3}
}
...
func (x *BeverageList) Reset() {
	*x = BeverageList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_beveragesmgmt_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *BeverageList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeverageList) ProtoMessage() {}

func (x *BeverageList) ProtoReflect() protoreflect.Message {
	mi := &file_beveragesmgmt_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeverageList.ProtoReflect.Descriptor instead.
func (*BeverageList) Descriptor() ([]byte, []int) {
	return file_beveragesmgmt_proto_rawDescGZIP(), []int{4}
}

func (x *BeverageList) GetBeverages() []*Beverage {
	if x != nil {
		return x.Beverages
	}
	return nil
...
var file_beveragesmgmt_proto_rawDesc = []byte{
	...
	,
...
var file_beveragesmgmt_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_beveragesmgmt_proto_goTypes = []interface{}{
	...
	(*GetBeveragesParams)(nil),     // 4: api.GetBeveragesParams
	(*BeverageList)(nil),           // 5: api.BeverageList
}
var file_beveragesmgmt_proto_depIdxs = []int32{
	...
	3, // 3: api.BeverageList.beverages:type_name -> api.Beverage
	2, // 4: api.BeveragesManagement.CreateBeverage:input_type -> api.CreateBeverageRequest
	4, // 5: api.BeveragesManagement.GetBeverages:input_type -> api.GetBeveragesParams
	3, // 6: api.BeveragesManagement.CreateBeverage:output_type -> api.Beverage
	5, // 7: api.BeveragesManagement.GetBeverages:output_type -> api.BeverageList
...
func file_beveragesmgmt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_beveragesmgmt_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBeveragesParams); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_beveragesmgmt_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeverageList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
